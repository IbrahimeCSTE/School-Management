...
import { deleteFileAction, deleteFileDesAction, fileDesAction, singleFileUploadAction } from '../../reducer/action';
...
const FileUpload = () => {
    ...
    const uploadSingleFile = async () => {
        ...
        dispatch(singleFileUploadAction(formData,singleFileOptions))
    ...
    const deleteFileDes=(file)=>{
        dispatch(deleteFileDesAction(file))
        ...
        <div className="row mt-3">
            <div className="col-6">
                <div className="form-group">
                    <label>Select carousel image</label>
